          ...
          <motion.div
            ...
            className={`absolute left-0 right-0 cursor-pointer rounded-tl-3xl rounded-tr-xl rounded-br-3xl rounded-bl-xl bg-gradient-to-b  ${
              isActive
                ...
                : "from-gray-900 to-gray-800 text-gray-300 shadow-md z-10" // 밝은 회색
          ...
          >
            ...
            <div className="flex justify-between items-center h-[80px]">
              <h3
                className={`text-2xl font-extrabold ${
                  isActive ? "text-gray-900" : "text-gray-300" // 밝은 회색
                }`}
              >
                {project.name}
              </h3>
            ...
            <div className="flex gap-[5px] font-semibold">
              <a
                ...
                className="hover:underline bg-gray-700 text-gray-200 rounded-full px-3 py-1 text-xs" // 톤 다운된 스타일
              >
                Github
              </a>
              <a
